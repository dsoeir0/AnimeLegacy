...
// Never cache the error fallback — would blank pages for the whole TTL on a single 429.
...
// Jikan sometimes returns 200 with an error JSON body instead of a real HTTP error code.
...
export const getCurrentSeason = async () => {
  ...
  // /seasons/now sometimes 5xx's while /seasons/{y}/{s} succeeds (different shard).
